...
/// <summary>Utility methods for working with directories.</summary>
internal static class DuDirectory
{
    // [250801]
    /// <summary>If the directory does not exist, creates it.</summary>
    ...
    // [250801]
    /// <summary>If the directory exists, deletes it and recreates it.</summary>
    /// <param name="path">The directory path.</param>
    ...
    // [250801]
    /// <summary>Verifies that the parent directory of a file exists.</summary>
    ...
    ///     their contents are also copied. Existing files in the target directory are overwritten.
    /// </remarks>
    ...
    ///     Files and directories specified in <paramref name="excludeFiles"/> and <paramref name="excludeDirs"/>
