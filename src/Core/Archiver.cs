...
internal static class Archiver
{
    ...
    /// <summary>Backs up repository data into zip archives.</summary>
    /// <remarks>
    /// The method first copies the selected source directories to the staging area.
    /// It then creates one zip archive per staged directory using the directory name and the current timestamp.
    /// </remarks>
    ...
    /// <param name="excludeFiles">The file names to exclude from staging.</param>
    /// <param name="excludeDirs">The directory names to exclude from staging.</param>
